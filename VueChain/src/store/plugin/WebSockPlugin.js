        ...
        return (event) => {
            ...
            switch(data.type) {
                ...
                case "ADD_BLOCK":
                    ...
                    break;
                case "SEARCH_BLOCK":
                    this._store.commit("searchBlock",data.obj);
                    break;
        ...
        return (action, state) => {
            ...
            switch(action.type){
                ...
                case "SearchCarNo":
                    ...
                    break;
                case "RequestSearchBlockchainSync":
                    this._websocket.send(JSON.stringify({type:"GET_ALL_SEARCH_BLOCK"}));
                    break;
